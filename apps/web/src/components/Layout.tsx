...
import { KeyboardCursorProvider } from '../hooks/useKeyboardCursor'
import { CaptureProvider } from '../hooks/useCapture'
import { CommandPaletteProvider, useCommandPalette } from '../hooks/useCommandPalette'
import { MonthScrubProvider } from '../hooks/useMonthScrub'
import { FHintProvider } from '../hooks/useFHints'
...
function KeyboardLayer() {
  ...
  useKeyboardShortcuts({ onCheatsheet: palette?.openCheatsheet ?? (() => {}) })
  // The cheatsheet and palette overlays are rendered by CommandPaletteProvider.
  return null
}
